...
axis([1,numofyear,0.9*min(data2(i,:)),max(data2(i,:))*1.2]);  %确定x轴与y轴框图大小
title(titlestr{i},'position',[numofyear/2,max(data2(i,:))*1.05],'FontName','Helvetica','FontSize',15);
xlim([1 numofyear]);
yticks('auto')
